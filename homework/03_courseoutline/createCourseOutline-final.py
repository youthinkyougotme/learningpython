...
# parser.add_argument('--include', help='A comma separated list of column names to be included in the output')
# parser.add_argument('--exclude', help='A comma seperated list of coumn names to be included in the output')
# options = parser.parse_args()

# if not options.include and not options.exclude :
#     parser.print_help()
#     sys.exit()
# elif options.include and options.exclude :
    # print 'both arguments were include. that is bad'
#    sys.exit()
