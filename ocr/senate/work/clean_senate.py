...
with open('senate.txt') as file :
    ...
    for line in file :
        ...
        # replace multiple single spaces
        ...
        if len(line_parts) == 3 :
            ...
            # need to find 4 columns
            #print '********** has less than 4 **********'

            third_item = line_parts[2]
            #print third_item
            #print type(third_item)
